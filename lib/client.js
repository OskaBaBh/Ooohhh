...
try {
    ...
    console.log("🌍 Connected to the Vajira")
} catch {
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/vajirabot1/KING-VAJIRA-MD')
	}
    }
    main()
    //========================================================================================================================================
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("✅ Vajira Login Successfull!");
                    ...
                    console.log("✅  External Vajira Plugins Installed!");
